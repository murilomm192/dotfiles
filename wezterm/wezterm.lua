...
config.default_cwd = "C:\\Users\\99810903\\OneDrive - Anheuser-Busch InBev\\Desktop\\Projetos"

config.default_prog = { "C:\\Windows\\System32\\WindowsPowerShell\\v1.0\\powershell.exe", "-NoLogo" }
config.font = wezterm.font('FiraCode Nerd Font', { weight = 600, italic = false })
config.font_size = 9
...
-- Keybindings
config.keys = {
	-- Activate Venv on current directory
	{ key = "e", mods = "ALT", action = act.Multiple {
							act.SendString 'venv/Scripts/activate',
							act.SendString '\r' }
},
